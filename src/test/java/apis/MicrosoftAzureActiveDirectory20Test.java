...
/*
    ...
    final OAuth20ServiceImpl service = new ServiceBuilder().apiKey(clientId).apiSecret(clientSecret).scope("openid User.Read profile email https://graph.microsoft.com/v1.0/me/memberOf")
        .callback("http://localhost:8080/app/oauth2/callback").build(.instance());
